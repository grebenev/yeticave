...
<form class="form container <?= $class_name; ?>" action="" method="post" enctype="multipart/form-data">
    <!-- form--invalid -->
    ...
    <div class="form__item <?= $class_name; ?>">
        ...
        <textarea id="message" name="reg[contacts]" placeholder="Напишите как с вами связаться"
